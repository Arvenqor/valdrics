<script lang="ts">
	...
	import { calculateLandingScenarioMetrics } from '$lib/landing/roi/scenario';
			...
			<div class="landing-public-surface landing-sim-results">
				...
				<div class="landing-sim-metrics">
					<div class="landing-sim-metric is-highlight is-primary">
						...
						<strong
							>{formatCurrency(
								scenarioMetrics.scenarioWasteRecoveryMonthlyUsd,
								currencyCode
							)}</strong
						>
					...
					<div class="landing-sim-metric is-highlight">
						...
						<strong
							>{formatCurrency(
								scenarioMetrics.scenarioWasteRecoveryWindowUsd,
								currencyCode
							)}</strong
						>
