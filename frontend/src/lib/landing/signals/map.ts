import { buildSnapshotTrace } from './trace';
export { nextSnapshotIndex } from './rotation';
export { buildSnapshotTrace } from './trace';
...
interface SignalLaneSnapshot extends SignalLaneDefinition {
	status: string;
	metric: string;
	detail: string;
