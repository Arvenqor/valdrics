import type { CtaVariant, HeroVariant, SectionOrderVariant, StorageLike } from './experiments';
...
interface LandingFunnelTelemetryContext {
	visitorId?: string;
	persona?: string;
	referrer?: string;
	pagePath?: string;
