...
import { detectLocalCurrency } from '$lib/landing/roi/calculator';
import {
	normalizeLandingCurrencyCode,
	type LandingCurrencyCode
} from '$lib/landing/roi/currencyPolicy';

export type { LandingCurrencyCode } from '$lib/landing/roi/currencyPolicy';
