...
import { COMPARISON_ROWS, structuredData } from '../content/page';
...
describe('landing pricing contract', () => {
	...
	it('keeps handoff-only pricing and trial claims out of landing sources', () => {
		const sourcePaths = [
			'src/lib/landing/components/LandingHero.svelte',
			'src/lib/landing/components/LandingFaqPricing.svelte',
			'src/lib/landing/components/LandingFeatures.svelte',
			'src/lib/landing/components/LandingCtaFooter.svelte',
			'src/lib/landing/components/LandingProblem.svelte',
			'src/lib/landing/components/LandingProofComparison.svelte',
			'src/lib/landing/content/page.ts'
		];
