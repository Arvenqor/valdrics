...
<AuthGate authenticated={!!data.user} action="manage customer comments">
	<section class="space-y-6">
		<div class="material-perspective">
			<header class="material-card-3d card border border-ink-800">
		...
		<div class="grid gap-6 lg:grid-cols-2">
			<div class="material-perspective">
				<section class="material-card-3d card border border-ink-800 space-y-4">
					...
					<form class="space-y-4" onsubmit={submit}>
						...
						<button type="submit" class="btn btn-primary material-button-3d" disabled={saving}>
