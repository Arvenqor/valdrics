...
Authorization: Bearer <access_token>`}</code
	...
	<div class="grid gap-6 md:grid-cols-3">
		{#each apiGroups as group (group.name)}
			<div class="material-perspective">
				<article class="material-card-3d glass-panel space-y-3">
	...
	<div class="flex flex-wrap gap-3">
		<a href={`${base}/docs`} class="btn btn-secondary material-button-3d">Back to Docs</a>
		<a href={`${base}/status`} class="btn btn-secondary material-button-3d">System Status</a>
	</div>
</section>
