<script lang="ts">
	import { Cloud, Copy, Download, ExternalLink, ShieldCheck, Wrench } from '@lucide/svelte';
...
{#if magicLink}
	...
	>
		<div class="magic-link-box__icon" aria-hidden="true">
...
<div class="manual-guide mb-8">
	<h4 class="font-bold text-ink-100 flex items-center gap-2 mb-4">
		<ShieldCheck size={16} class="text-accent-500" aria-hidden="true" />
