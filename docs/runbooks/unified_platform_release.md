...
project service-account principal set and the production Cloud Run service
agent. Keep `PRODUCTION_GCP_PROJECT_ID` and `PRODUCTION_GCP_PROJECT_NUMBER`
repository variables aligned with the production GitHub environment.
