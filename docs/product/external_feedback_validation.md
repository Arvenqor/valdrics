...
| GreenOps and carbon execution | Present | `app/modules/reporting/api/v1/carbon.py`, `frontend/src/routes/docs/technical-validation/+page.svelte` | Carbon budget, intensity, and scheduling recommendations are active. |
...
| Geopolitical / compliance-aware optimization | Partial | `docs/product/launch-market-positioning.md`, `frontend/src/lib/content/publicContent.proof.ts`, `frontend/src/lib/landing/realtimeSignalMap.ts` | Residency and sovereignty posture exists, but there is no active placement optimizer that weighs law, sanctions, tax, and cost together. |
