"""Bootstrap a deterministic sqlite fixture for frontend Playwright E2E and start the API."""
...
def resolve_fixture() -> PlaywrightE2EFixture:
    return PlaywrightE2EFixture(
        database_url=_resolve_env(
            "DATABASE_URL",
            "sqlite+aiosqlite:////tmp/valdrics-frontend-playwright.sqlite3",
        ),
        tenant_id=UUID(
            _resolve_env(
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Create a deterministic sqlite-backed Valdrics fixture for frontend Playwright E2E "
