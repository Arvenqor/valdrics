...
<script lang="ts">
	...
	function pricingPlanHref(plan: (typeof PRICING)[number]): string {
...
<svelte:head>
	<title
		>Valdrics — Cloud & Software Spend Governance | Approval Workflows & Ownership Tracking</title
	>
	<meta
		name="description"
		content="Valdrics helps engineering and finance teams stop wasting money on cloud and software by enforcing approval workflows, ownership tracking, and governance policies before spend is committed. AWS, GCP, Azure + 100s of SaaS tools."
	/>
	<meta
		name="keywords"
	...
	<meta
		property="og:title"
		content="Valdrics — Govern cloud and software spend before the bill arrives"
	/>
	<meta
		property="og:description"
		content="Approval workflows, ownership tracking, and governance policies for cloud and SaaS spend. Stop waste before it reaches the invoice."
	/>
	...
	<meta
		...
		content="Approval workflows, ownership tracking, and policy enforcement for cloud and SaaS spend. Engineering and finance, finally aligned."
	/>
		...
		<a href={appPath('/')} class="nav__logo" aria-label="Valdrics home">
			<div class="nav__mark" aria-hidden="true">
				<svg width="15" height="15" viewBox="0 0 20 20" fill="none">
					...
					<path
						d="M6 10L10 6L14 10L10 14Z"
						fill="rgba(0,207,124,0.2)"
						stroke="var(--jade)"
						stroke-width="1"
					/>
...
<section class="hero" id="hero" aria-label="Valdrics governance platform hero">
	...
	<div class="hero__inner">
		...
		<div
			class="hero__preview"
			aria-label="Live approval queue preview showing governance in action"
		>
            ...
            {heroCardState === 'approved'
					...
					<div class="hero-card__cost">
						...
						{:else}
							<div class="hero-card__decision hero-card__decision--denied">
								Denied · over budget
							</div>
						{/if}
					</div>
	...
	<div class="ticker__track">
		{#each Array(2) as _}
			<div class="ticker__item">
				<span class="tdot"></span> Avg. <strong>$34K/mo</strong> saved in first 90 days
			</div>
			<div class="ticker__item">
				<span class="tdot"></span> Cloud <strong>+</strong> SaaS in one governance view
			</div>
			<div class="ticker__item"><span class="tdot"></span> Audit evidence · DPA support</div>
			<div class="ticker__item">
				<span class="tdot"></span> <strong>Shadow IT</strong> detected and consolidated
			</div>
			<div class="ticker__item">
				<span class="tdot"></span> First approval workflow live in <strong>&lt; 20 min</strong>
			</div>
			<div class="ticker__item">
				<span class="tdot"></span> <strong>100+ SaaS</strong> integrations via OAuth
			</div>
			<div class="ticker__item">
				<span class="tdot"></span> Read-only access · <strong>no write permissions</strong>
			</div>
		{/each}
	</div>
</div>
	...
	<div class="container">
		<div use:reveal>
			...
			<h2 class="section-title">
				Most tools tell you what went wrong<br />after the invoice arrives.
			</h2>
			<p class="section-sub">
				Monitoring tells you the bill was too high. Governance stops it from getting that high in
				the first place. There is a meaningful difference.
			</p>
		</div>
...
<section class="features" id="features">
	<div class="container">
		<div use:reveal>
			...
			<p class="section-sub">
				Every dollar Valdrics saves traces back to a specific governance action. An approval denied.
				An owner reclaiming a resource. A policy blocking a duplicate.
			</p>
		</div>
		...
		<div class="features__grid">
			...
			<div class="fcard fcard--large fcard--jade" use:reveal={{ delay: 80 }}>
				<div class="fcard__icon fcard__icon--jade">
					<svg
						...
						fill="none"
						stroke="currentColor"
						stroke-width="1.8"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg
					>
				</div>
				<h3 class="fcard__title">Approval Workflows</h3>
				<p class="fcard__desc">
					Every cloud resource and software request passes through a policy-checked approval gate
					before spend is committed. Budget, security, vendor, and region policies run
					automatically. Approvers see the full cost impact before they decide.
				</p>
			...
			<div class="fcard__col">
				<div class="fcard fcard--ion" use:reveal={{ delay: 160 }}>
					...
					<p class="fcard__desc">
						Every cloud resource and SaaS licence gets a named owner. Owners receive quarterly
				...
				<div class="fcard fcard--violet" use:reveal={{ delay: 220 }}>
					...
					<p class="fcard__desc">
						40+ pre-built governance policies. Budget limits, vendor lists, DPA requirements, data
						residency, commitment thresholds. Enterprise teams write custom rules in the policy
						editor.
					</p>
					<div class="fcard__stat">
		...
		<div class="features__grid features__grid--flipped" style="margin-top: 14px;">
			...
			<div class="fcard__col">
				<div class="fcard fcard--ruby" use:reveal={{ delay: 80 }}>
					...
					<p class="fcard__desc">
						Cross-references cloud billing, corporate card, and expense feeds against your approved
						tool inventory. Unapproved tools are flagged and consolidated — typically saving 15–25%
				...
				<div class="fcard fcard--amber" use:reveal={{ delay: 160 }}>
					...
					<p class="fcard__desc">
						Every saving is tagged to the governance action that produced it. Finance gets a clear
			...
			<div class="fcard fcard--large fcard--ion" use:reveal={{ delay: 120 }}>
				<div class="fcard__icon fcard__icon--ion">
					<svg
						...
						fill="none"
						stroke="currentColor"
						stroke-width="1.8"><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg
					>
				</div>
				<h3 class="fcard__title">Unified Spend Topology</h3>
				<p class="fcard__desc">
					AWS, GCP, Azure, and 100+ SaaS tools unified in one living spend map. Cloud infrastructure
					and software costs in the same inventory, the same approval queue, the same governance
					layer. The only platform that covers both.
				</p>
				...
				<div class="fcard__illustration">
					<svg viewBox="0 0 280 80" style="width:100%;display:block;" preserveAspectRatio="none">
						...
						<path
							d="M0,58 C18,52 35,62 52,56 C69,50 87,42 104,36 C121,30 139,22 156,18 C173,14 191,28 208,32 C225,36 243,30 280,34 L280,80 L0,80 Z"
							fill="url(#tg)"
						/>
						<path
							d="M0,58 C18,52 35,62 52,56 C69,50 87,42 104,36 C121,30 139,22 156,18 C173,14 191,28 208,32 C225,36 243,30 280,34"
							fill="none"
							stroke="var(--ion)"
							stroke-width="1.8"
						/>
						...
						<text
							...
							font-size="8"
							fill="var(--ruby)"
							font-family="JetBrains Mono,monospace">spike detected</text
						>
						<path
							d="M0,66 C18,62 35,68 52,64 C69,60 87,55 104,50 C121,45 139,38 156,35 C173,32 191,42 208,46 C225,50 243,45 280,48"
							fill="none"
							stroke="var(--violet)"
							stroke-width="1.2"
							opacity=".6"
...
<section class="how" id="how-it-works">
	<div class="container">
		...
		<div class="how__steps" use:reveal={{ delay: 100 }}>
			{#each [{ n: '01', title: 'Connect your clouds & tools', desc: 'Read-only IAM role for AWS, service account for GCP, Azure app registration. OAuth for 100+ SaaS tools. 3–4 minutes per provider.' }, { n: '02', title: 'Valdrics maps your inventory', desc: 'We build a full registry of every cloud resource and software tool — with costs, teams, and ownership inferred from tags automatically.' }, { n: '03', title: 'Set your governance policies', desc: 'Pick from 40+ pre-built templates or write custom rules. Budget limits, vendor lists, DPA requirements — all live in minutes.' }, { n: '04', title: 'Requests flow through the gate', desc: 'Every new resource request triggers a policy check and approval workflow. The right approver is notified in Slack with a one-click decision.' }, { n: '05', title: 'Measure governance ROI', desc: 'Every denied request, reclaimed licence, and consolidated tool is tagged to a dollar saving. Share the report with Finance in one click.' }] as step, i}
				<div class="how__step">
	...
	<div class="container">
		...
		<div class="comparison__wrap" use:reveal={{ delay: 100 }}>
			<table class="comp-table" aria-label="Feature comparison">
				...
				<tbody>
					{#each [['Approval workflows', '✓ policy-checked', 'Partial — SaaS only', '✕', '✕'], ['Ownership tracking', '✓ cloud + SaaS', 'Partial — SaaS only', '✕', '✕'], ['Policy engine', '✓ 40+ templates', 'Partial — basic rules', 'Partial', '✕'], ['Shadow IT detection', '✓ cloud + SaaS', '✓ SaaS only', '✕', '✕'], ['Unified cloud + SaaS', '✓', '✕ SaaS only', '✕ cloud only', '✕ AWS only'], ['Proactive governance', '✓', '✕', '✕', '✕'], ['Starting price', '$299/month', '$$$$ custom', '$$$$ custom', 'Free']] as row}
						<tr>
				...
				<article class="pcard" class:pcard--popular={plan.popular} use:reveal={{ delay: i * 80 }}>
					...
					<ul class="pcard__features">
						{#each plan.features as f}
							<li
								class="pcard__feature"
								class:pcard__feature--disabled={typeof f === 'object' && f.disabled}
							>
...
<div class="trust-bar">
	<div class="trust-bar__inner">
		{#each ['Read-only access', 'Tenant-aware controls', 'Approval workflows', 'Audit evidence exports', 'DPA support', 'Secure data handling'] as badge}
...
<section class="cta">
	...
	<div class="container" style="text-align:center;position:relative;z-index:1;">
		<div use:reveal>
			...
			<p class="cta__sub">
				No credit card. No sales call. No agents to install.<br />Connect your cloud and your first
				approval workflow is live in 20 minutes.
			</p>
			<div class="cta__actions">
				<a href={signupHref('landing_final_cta')} class="btn btn--jade btn--lg"
					>Start free — no card needed →</a
				>
				<a href={salesHref('landing_final_demo')} class="btn btn--ghost btn--lg">Book a live demo</a
				>
			</div>
			<p class="cta__note">14-day trial · Read-only access · Cancel anytime</p>
		</div>
	</div>
</section>
...
<footer class="footer">
	<div class="container">
					...
					<div class="nav__mark">
						<svg width="13" height="13" viewBox="0 0 20 20" fill="none"
							...
							/><path
								...
								stroke="var(--jade)"
								stroke-width="1"
							/><circle cx="10" cy="10" r="1.8" fill="var(--jade)" /></svg
						>
					</div>
					<span>VALDRICS</span>
				</a>
				<p>
					Cloud and software spend governance for engineering and finance teams. Approval workflows,
				...
				<div>
					...
					<ul class="footer__links">
						{#each col.links as link}
							<li><a href={footerHref(link)}>{link}</a></li>
						{/each}
					</ul>
				</div>
			{/each}
		...
		<div class="footer__bottom">
			<span class="footer__copy">© 2026 Valdrics · valdrics.com · Governed FinOps</span>
			<div class="footer__social" aria-label="Social media links">
				<a
					href="https://twitter.com/valdrics"
					class="social-link"
					aria-label="Valdrics on Twitter"
					rel="noopener">𝕏</a
				>
				<a
					href="https://linkedin.com/company/valdrics"
					class="social-link"
					aria-label="Valdrics on LinkedIn"
					rel="noopener">in</a
				>
				<a
					href="https://github.com/valdrics"
					class="social-link"
					aria-label="Valdrics on GitHub"
					rel="noopener">gh</a
				>
			</div>
		</div>
...
<style>
	...
	.gate-glow {
		...
		box-shadow: 0 0 12px rgba(0, 207, 124, 0.4);
	}
	.gate-label {
	...
	.fcard--ion::before {
		background: linear-gradient(to right, transparent, var(--ion), transparent);
	}
	.fcard--violet::before {
		background: linear-gradient(to right, transparent, var(--violet), transparent);
	}
	.fcard--ruby::before {
		background: linear-gradient(to right, transparent, var(--ruby), transparent);
	}
	.fcard--amber::before {
	...
	.fcard__icon--violet {
		background: rgba(146, 112, 255, 0.1);
		border: 1px solid rgba(146, 112, 255, 0.2);
		color: var(--violet);
	}
	.fcard__icon--ruby {
		background: rgba(255, 58, 92, 0.1);
	...
	.pcard__feature--disabled .pcard__check {
		color: var(--muted);
	}
	...
	.cta__glow {
		...
		height: 600px;
		border-radius: 50%;
		background: radial-gradient(circle, rgba(0, 207, 124, 0.07), transparent 70%);
	}
	.cta__gate {
		position: absolute;
		top: 0;
